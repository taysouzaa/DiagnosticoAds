/**
 * Seção "O que será analisado" da landing page.
 */
/**
 * Lista de pontos analisados durante a chamada estratégica.
 * Mantida como array estático para fácil manutenção e ordem controlada.
 */
const items = [
  {
